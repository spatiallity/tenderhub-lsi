-- =============================================================
-- TenderHub User Management — Supabase Setup
...
-- 6. (Optional) Seed first admin user
-- Replace the UUID with your own user's UUID from auth.users after signing up once.
-- UPDATE public.profiles SET role = 'admin' WHERE email = 'admin@sucofindo.co.id';
