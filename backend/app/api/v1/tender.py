...
async def search_tenders(
    ...
    if not keywords:
        keywords = [
            ...
            {"id": 3, "text": "ROW SUTT", "subporto": "SDA", "is_active": True},
            {"id": 4, "text": "bush clearing", "subporto": "SDA", "is_active": True},
            {"id": 5, "text": "inventarisasi aset", "subporto": "SDA", "is_active": True},
            {"id": 6, "text": "rehabilitasi", "subporto": "SDA", "is_active": True},
            {"id": 7, "text": "DED", "subporto": "SDA", "is_active": True},
            {"id": 8, "text": "feasibility study kawasan", "subporto": "SDA", "is_active": True},
            {"id": 9, "text": "survei", "subporto": "FLP", "is_active": True},
            {"id": 10, "text": "pendataan", "subporto": "FLP", "is_active": True},
            {"id": 11, "text": "oversight services", "subporto": "FLP", "is_active": True},
            {"id": 12, "text": "instrumen survei", "subporto": "FLP", "is_active": True},
            {"id": 13, "text": "kajian kebijakan", "subporto": "FLP", "is_active": True},
            {"id": 14, "text": "studi bandara", "subporto": "FLP", "is_active": True},
            {"id": 15, "text": "IPRO", "subporto": "FITI", "is_active": True},
            {"id": 16, "text": "investment project ready", "subporto": "FITI", "is_active": True},
            {"id": 17, "text": "masterplan kawasan", "subporto": "FITI", "is_active": True},
            {"id": 18, "text": "roadmap investasi", "subporto": "FITI", "is_active": True},
            {"id": 19, "text": "studi kelayakan", "subporto": "FITI", "is_active": True},
            {"id": 20, "text": "peta peluang investasi", "subporto": "FITI", "is_active": True},
            {"id": 21, "text": "konsultan investasi", "subporto": "FITI", "is_active": True},
        ]
